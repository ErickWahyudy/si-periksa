...
//kode 2
// Memisahkan data menjadi dua kelompok berdasarkan umur
$data_umur_diatas_55 = array_filter($antrian_berikut, function ($periksa) {
    $umur = $periksa['umur'];
    return $umur >= 55;
});

$data_umur_dibawah_55 = array_filter($antrian_berikut, function ($periksa) {
    $umur = $periksa['umur'];
    return $umur < 55;
});
...
// Menggabungkan kedua kelompok data
$antrian_berikut = array_merge($data_umur_diatas_55, $data_umur_dibawah_55);
